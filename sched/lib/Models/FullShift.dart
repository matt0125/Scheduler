class FullShift {
  ...
  DateTime? shiftStartTime; // Add this property
  ...
  FullShift({
    ...
    if (this.startTime != null && this.endTime != null) {
      ...
      // Create DateTime object for shift start time
      this.shiftStartTime = DateTime(2023, 1, 1, startH, startM);
      ...
      this.printTime =
      "${startH}:${startM.toString().padLeft(2, '0')} ${startAM != endAM ? startAM : ""}- ${endH}:${endM.toString().padLeft(2, '0')} ${endAM}";
